document.addEventListener("DOMContentLoaded", function () {
  ...
  addToCartButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      const productPrice =
        this.parentElement.parentElement.querySelector(".price p").textContent;
      const productImage =
        this.parentElement.parentElement.querySelector(".main-item").src;
